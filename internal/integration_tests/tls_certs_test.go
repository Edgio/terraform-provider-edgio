...
func TestTlsCerts_Lifecycle(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: getTlsCertsConfig(client_id, client_secret, organization_id, slug_name, "example-environment", true, true),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrPair(
						"edgio_tls_cert.cert_test", "environment_id",
			...
			{
				Config: getTlsCertsConfig(client_id, client_secret, organization_id, slug_name, "updated-environment", false, false),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrPair(
						"edgio_tls_cert.cert_test", "environment_id",
						"edgio_environment.env_test", "id",
...
func getTlsCertsConfig(clientID, clientSecret, organizationID, propertySlug, envName string, canMembersDeploy, httpRequestLogging bool) string {
	return fmt.Sprintf(`
	provider "edgio" {
		client_id     = "%s"
		client_secret = "%s"
	...
	resource "edgio_tls_cert" "cert_test" {
