...
func ConvertCdnConfigToNative(model *CDNConfigurationModel) dtos.CDNConfiguration {
...
func ConvertNativeToCdnConfig(dto *dtos.CDNConfiguration) CDNConfigurationModel {
	rulesStr := ""
	if dto.Rules != nil {
...
func convertOriginsToNative(origins []OriginModel) []dtos.Origin {
...
func convertNativeToOrigins(origins []dtos.Origin) []OriginModel {
	var m []OriginModel
	for _, origin := range origins {
		m = append(m, OriginModel{
...
func convertHostnamesToNative(hostnames []HostnameModel) []dtos.Hostname {
...
func convertNativeToHostnames(hostnames []dtos.Hostname) []HostnameModel {
	var natives []HostnameModel
	for _, hostname := range hostnames {
		natives = append(natives, HostnameModel{
...
func convertTLSToNative(tls TLSModel) dtos.TLS {
	return dtos.TLS{
...
func convertNativeToTLS(tls dtos.TLS) TLSModel {
	return TLSModel{
...
func convertRetryToNative(retry *RetryModel) *dtos.Retry {
	if retry == nil {
		return nil
	}
...
func convertNativeToRetry(retry *dtos.Retry) *RetryModel {
	if retry == nil {
		return nil
	}
...
func convertShieldsToNative(shields *ShieldsModel) *dtos.Shields {
	if shields == nil {
		return nil
	}
...
func convertNativeToShields(shields *dtos.Shields) *ShieldsModel {
	if shields == nil {
		return nil
	}
...
func convertTLSVerifyToNative(tlsVerify *TLSVerifyModel) *dtos.TLSVerify {
	if tlsVerify == nil {
		return nil
	}
...
func convertNativeToTLSVerify(tlsVerify *dtos.TLSVerify) *TLSVerifyModel {
	if tlsVerify == nil {
		return nil
	}

	return &TLSVerifyModel{
...
func convertHostsToNative(hosts []HostModel) []dtos.Host {
...
func convertNativeToHosts(hosts []dtos.Host) []HostModel {
	var m []HostModel
	for _, host := range hosts {
		m = append(m, HostModel{
...
func convertLocationToNative(locations []LocationModel) []dtos.Location {
...
func convertNativeToLocation(locations []dtos.Location) []LocationModel {
	var m []LocationModel
	for _, location := range locations {
		m = append(m, LocationModel{
