...
func mockAllEnvironmentMethods(mockClient *edgio_api.MockEdgioClient, methods ...MockMethod) {
...
func TestEnvironmentResource_Lifecycle(t *testing.T) {
	...
	mockAllEnvironmentMethods(mockClient, MockCreate, MockGet, MockUpdate, MockDelete)
